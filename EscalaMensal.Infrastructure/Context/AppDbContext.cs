...
namespace EscalaMensal.Infrastructure.Context
{
    ...
    new { Id = 4, Nome = "Maria", Nivel = NivelEnum.Nivel1, Cargo = CargoEnum.Coroinha, Ativo = false, HorasPreferenciaisRaw = "07:30", DiasDisponiveisRaw = "Wednesday,Thursday,Saturday", LimitePermitido = 3 }
);
